...
{
    const ENTITY_CLASS = 'Zero\ApiBaseBundle\Tests\Manager\EntityManagerTestEntity';
    const FORM_CLASS = 'Zero\ApiBaseBundle\Tests\Manager\EntityManagerTestFormType';
