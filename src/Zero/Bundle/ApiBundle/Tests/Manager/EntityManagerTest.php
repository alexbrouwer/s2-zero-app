...
use Zero\Bundle\ApiBundle\Exception\InvalidFormException;
use Zero\Bundle\ApiBundle\Manager\EntityManager;

class EntityManagerTest extends \PHPUnit_Framework_TestCase
{
    const ENTITY_CLASS = 'Zero\Bundle\ApiBundle\Tests\Manager\EntityManagerTestEntity';
    const FORM_CLASS = 'Zero\Bundle\ApiBundle\Tests\Manager\EntityManagerTestFormType';
    ...
    /**
     * @expectedException \Zero\Bundle\ApiBundle\Exception\InvalidFormException
     */
