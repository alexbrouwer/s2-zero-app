...
namespace Zero\Bundle\ApiBundle\Tests\Listener;

use Symfony\Component\HttpFoundation\Request;
use Symfony\Component\HttpFoundation\Response;
use Symfony\Component\HttpKernel\HttpKernelInterface;
use Zero\Bundle\ApiBundle\Listener\InvalidFormExceptionListener;
...
class InvalidFormExceptionListenerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testOnKernelException()
    {
        ...
        $exception = \Mockery::mock('\Zero\Bundle\ApiBundle\Exception\InvalidFormException');
