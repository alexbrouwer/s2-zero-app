...
namespace Zero\Bundle\UserBundle\Tests\Form\Type;

use Symfony\Component\Form\PreloadedExtension;
use Symfony\Component\Form\Test\TypeTestCase;
use Zero\Bundle\UserBundle\Entity\User;
use Zero\Bundle\UserBundle\Form\Type\UserType;
...
class UserTypeTest extends TypeTestCase
{
    ...
    {
        $group = \Mockery::mock('Zero\Bundle\UserBundle\Entity\User\Group');
        ...
        return array(
            'Zero\Bundle\UserBundle\Entity\User\Group' => $userGroupRep
        );
    }
